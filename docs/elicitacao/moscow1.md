...
|8|O sistema deve [recomendar](/modelagem/lexico#recomendacao) músicas, [Playlists](/modelagem/lexico#playlist), [Estações de rádio](/modelagem/lexico#estacoes-de-radio) para o usuário, dependendo do seu gosto.|Must|NF|
...
|30|O sistema deve poder [recomenda](/modelagem/lexico#recomendacao) [conteúdo](/modelagem/lexico#conteudo) de acordo com a atividade do usuário.|Must|NF|
|31|O sistema deve poder criar [Playlists](/modelagem/lexico#playlist) de acordo com o [conteúdo](/modelagem/lexico#conteudo) mais ouvido pelos usuários.|Would|NF|
...
|91|O sistema deve realizar confirmações de [cadastro](/modelagem/lexico#cadastrar).|Should|NF|
...
|94|O usuário deve poder visualizar as capas de [álbuns](/modelagem/lexico#album).|Could|NF|
